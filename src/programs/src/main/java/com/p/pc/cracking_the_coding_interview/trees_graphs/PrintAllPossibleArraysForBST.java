...
public class PrintAllPossibleArraysForBST {
    ...
    private void weaveList(LinkedList<Integer> l, LinkedList<Integer> r, LinkedList<Integer> prefix, List<LinkedList<Integer>> weavedList) {
        ...
        // Process left list
        Integer lhead = l.removeFirst();
        prefix.addLast(lhead); // add the head to the end of the prefix to maintain the order
        weaveList(l, r, prefix, weavedList);
        ...
        // Process right list
        Integer rhead = r.removeFirst();
        prefix.addLast(rhead); // add the head to the end of the prefix to maintain the order
        weaveList(l, r, prefix, weavedList);
