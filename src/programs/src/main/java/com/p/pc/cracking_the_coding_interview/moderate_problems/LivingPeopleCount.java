...
public class LivingPeopleCount {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(yearWithMostNumberOfPeople(population, minYear, maxYear)));
    }
    ...
    private static int[] yearWithMostNumberOfPeople(People[] population, int minYear, int maxYear) {
        ...
        calculatePopulationByYear(population, yearPopulationMap, minYear, maxYear);
        return computeYearWithMostPeople(yearPopulationMap, minYear, maxYear);
    }

    private static void calculatePopulationByYear(People[] population, Map<Integer, Integer> yearPopulationMap, int minYear, int maxYear) {
